                    ...
                    <div class="container">
							...
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <?php
                                        ...
                                        $sutaz_id=$params['id'];
                                        $query=mysqli_query($con_reg,"select * from seminare where id=$sutaz_id");
                                ...
                                <div class="card-box widget-box-one">
                                    <div class="wigdet-one-content">
                                      ...
                                      ?>
                                        ...
                                        elseif(date("Y-m-d") > $regRow['registraciaEnd']){
                                          $registraciaKoniec = date("d.m.Y", strtotime($regRow['registraciaKoniec']));
                                          ?>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="Statistics">Registrovaní účastníci</p>
                                            <?php
                                                $sutazId = intval($sutaz_id);
                                                $table = "_seminar$sutazId";
